...
float threshold1=2;   //medium
float threshold2=1.8;   // highest
float threshold3=1.6;  // lowest
float thresholdabove=2.4;   // release th
...
int innercount2=0;
// Threshold for signal 1 ---- needs to be changed depending on the person
float threshold12=1.8;   //
float threshold22=1.6;
float threshold32=1.4;
float thresholdabove2=2.4;
...
float continouspulse3=0;  
int innercount3=0;  
// Threshold for signal 3 ---- needs to be changed depending on the person
float threshold13=2;   //medium
float threshold23=1.8;   // highest
float threshold33=1.6;  // lowest
float thresholdabove3=2.4;   // release th
...
float continouspulse4=0;
int innercount4=0;
// Threshold for signal 4 ---- needs to be changed depending on the person
float threshold14=2;   //medium
float threshold24=1.8;   // highest
float threshold34=1.6;  // lowest
float thresholdabove4=2.4;   // release th
...
float threshold25=1.8;   // highest
float threshold35=1.6;  // lowest
float thresholdabove5=2.4;   // release th
...
if(innercount==1){
   if(voltage<maxpulse){
      ...
      if(maxpulse>threshold2 && maxpulse<threshold1){
          maxpulse1print=maxpulse1print;
          continouspulse=1;
         
        }else if(maxpulse<threshold2 && maxpulse>threshold3){
          
           continouspulse=1;
        }else if(maxpulse<threshold3 ){
...
if(innercount2 == 0){
  if(voltage2<threshold12){
    innercount2++;
    maxpulse2=threshold12;
    maxpulse1print2=0;
    continouspulse2=0;
  }
}
...
if(innercount2==1){
   if(voltage2<maxpulse2){
      ...
      if(maxpulse2>threshold22 && maxpulse2<threshold12){
          maxpulse1print2=maxpulse1print2;
          continouspulse2=1;
         
        }else if(maxpulse2<threshold22 && maxpulse2>threshold32){
          
           continouspulse2=1;
        }else if(maxpulse2<threshold32 ){
...
if(innercount3 == 0){
  if(voltage3<threshold13){
    innercount3++;
    maxpulse3=threshold13;
    maxpulse1print3=0;
    continouspulse3=0;
  }
}
...
if(innercount3==1){
   if(voltage3<maxpulse3){
      ...
      if(maxpulse3>threshold23 && maxpulse3<threshold13){
          maxpulse1print3=maxpulse1print3;
          continouspulse3=1;
         
        }else if(maxpulse3<threshold23 && maxpulse3>threshold33){
          
           continouspulse3=1;
        }else if(maxpulse3<threshold33 ){
...
if(innercount4 == 0){
  if(voltage4<threshold14){
    innercount4++;
    maxpulse4=threshold14;
    maxpulse1print4=0;
    continouspulse4=0;
  }
}
...
if(innercount4==1){
   if(voltage4<maxpulse4){
      ...
      if(maxpulse4>threshold24 && maxpulse4<threshold14){
          maxpulse1print4=maxpulse1print4;
          continouspulse4=1;
         
        }else if(maxpulse4<threshold24 && maxpulse4>threshold34){
          
           continouspulse4=1;
        }else if(maxpulse4<threshold34 ){
...
if(innercount5 == 0){
  if(voltage5<threshold15){
    innercount5++;
    maxpulse5=threshold15;
    maxpulse1print5=0;
    continouspulse5=0;
  }
}
...
if(innercount5==1){
   if(voltage5<maxpulse5){
      ...
      if(maxpulse5>threshold25 && maxpulse5<threshold15){
          maxpulse1print5=maxpulse1print5;
          continouspulse5=1;
         
        }else if(maxpulse5<threshold25 && maxpulse5>threshold35){
          
           continouspulse5=1;
        }else if(maxpulse5<threshold35 ){
...
if(innercount6 == 0){
  if(voltage6<threshold16){
    innercount6++;
    maxpulse6=threshold16;
    maxpulse1print6=0;
    continouspulse6=0;
  }
}
...
if(innercount6==1){
   if(voltage6<maxpulse6){
      ...
      if(maxpulse6>threshold26 && maxpulse6<threshold16){
          maxpulse1print6=maxpulse1print6;
          continouspulse6=1;
         
        }else if(maxpulse6<threshold26 && maxpulse6>threshold36){
          
           continouspulse6=1;
        }else if(maxpulse6<threshold36){
