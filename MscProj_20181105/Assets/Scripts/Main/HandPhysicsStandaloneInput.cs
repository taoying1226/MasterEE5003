...
namespace HandPhysicsExtenstions
{
    ...
    public class HandPhysicsStandaloneInput : MonoBehaviour
    {
        ...
        private string filename = "F:\\EE5003_MscProject\\MscProj_20181105\\Assets\\Scripts\\Main\\SerialCommunication.py";
        ...
        void Update()
        {
            ...
            if (grabStep == 0)
            {
                ...
                {
                    Controller.RotateWrist(30);//控制手腕弯曲的角度：25度
                }
                else if (command[5] == 2)
                {
                    Controller.RotateWrist(60);
                }
                else if(command[5] == 0)
                {
                    Controller.RotateWristTo(0);//让手腕回到0度
                }
            }
            #endregion
